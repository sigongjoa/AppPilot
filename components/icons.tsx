...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z"></path><path d="M22 2L20 6"></path><path d="M2 22L6 20"></path><path d="M6 2L2 6"></path><path d="M20 22L22 20"></path></svg>
);
...
export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9 18h6v-2.3c1.4-.2 2.5-1.1 3-2.7 0-1.7-1-3-3-3V9c0-1.1-.9-2-2-2h-2c-1.1 0-2 .9-2 2v1c-2 0-3 1.3-3 3 .5 1.6 1.6 2.5 3 2.7V18Z"></path><path d="M12 3a1 1 0 0 1 1 1v1a1 1 0 0 1-2 0V4a1 1 0 0 1 1-1Z"></path><path d="m19.07 5.93-1.42 1.42"></path><path d="M4.93 5.93l1.42 1.42"></path><path d="M21 12h-1a1 1 0 0 0-1 1v0a1 1 0 0 0 1 1h1"></path><path d="M4 12H3a1 1 0 0 0-1 1v0a1 1 0 0 0 1 1h1"></path><path d="m17.66 17.66 1.41 1.41"></path><path d="m5.93 19.07 1.41-1.41"></path><path d="M12 21a1 1 0 0 1-1-1v-1a1 1 0 0 1 2 0v1a1 1 0 0 1-1 1Z"></path></svg>
);
...
export const PackageIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="16.5" y1="9.4" x2="7.5" y2="4.2"></line><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
);

export const RocketIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.33-.04-3.1-.73-.77-2.24-.78-3.1-.04-1.26 1.5-2.24 2-2.24 2z"></path><path d="m21.5 2.5-19 19"></path><path d="M13 2.76a2.5 2.5 0 0 1 3.54 3.54l-5.8 5.8-3.54-3.54 5.8-5.8Z"></path><path d="M16 8.5s3.5-1.5 3.5-5-5 3.5-5 3.5"></path></svg>
);

export const GitCommitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="3"></circle><line x1="3" y1="12" x2="9" y2="12"></line><line x1="15" y1="12" x2="21" y2="12"></line></svg>
);
...
export const FlaskConicalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M10.8 2.2a2 2 0 0 1 3.3 0l5.9 10.9a2 2 0 0 1-1.7 2.9H6.6a2 2 0 0 1-1.7-2.9l5.9-10.9Z"></path><path d="M6 16h12"></path><path d="M8 22h8"></path><path d="M8 19h8"></path></svg>
);
...
export const BugIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 20c-3.3 0-6-2.7-6-6V8h12v6c0 3.3-2.7 6-6 6Z"></path><path d="M12 20v-4"></path><path d="M18.5 12h-13"></path><path d="m10 9-3-3"></path><path d="m14 9 3-3"></path><path d="m6.5 12-3.5-2"></path><path d="m17.5 12 3.5-2"></path><path d="M4 6.5l2 3"></path><path d="M20 6.5l-2 3"></path></svg>
);
